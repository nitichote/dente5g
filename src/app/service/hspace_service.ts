...
api = 'http://127.0.0.1:3002/kpiscore/';
  api1="";
  ...
  async get_amp() {
    let api2020 = this.api + "amp";

    return await this._http2.get(api2020).toPromise();
  }
  async get_hoscpho() {
    let api2020 = this.api + "hoscpho";

    return await this._http2.get(api2020).toPromise();
  }
  async get_kpi_rpst_set() {
    let api2020 = this.api + "kpi_rpst_set";
